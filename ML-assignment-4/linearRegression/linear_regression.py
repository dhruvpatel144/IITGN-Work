...
class LinearRegression():
  ...
  def compute_gradient(self, X, y, penalty='unregularized', alpha=1.0):
  ...
  def fit_gradient_descent(self, X, y, batch_size, alpha=1.0, gradient_type='manual', penalty_type='unregularized', num_iters=50, lr=0.01):
  ...
  def fit_SGD_with_momentum(self, X,y, penalty='l2', alpha=1.0, lr=0.03, max_iter=1000, tol=1e-7, momentum=0.9):
