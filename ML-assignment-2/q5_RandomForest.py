...
X, y = make_classification(n_samples=50,n_features=5, n_redundant=0, n_informative=4, random_state=7, n_clusters_per_class=1, class_sep=0.5, n_classes=5)
X = pd.DataFrame(X)
y = pd.Series(y)
...
Regressor_RF = RandomForestRegressor(10, criterion = 'varaiance')
